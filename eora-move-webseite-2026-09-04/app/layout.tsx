...
export const metadata: Metadata = {
  metadataBase: new URL('https://eora-move.khairab.chatgpt.site'),
  ...
  openGraph: {
    ...
    images: [{ url: 'https://eora-move.khairab.chatgpt.site/og.png', width: 1664, height: 936, alt: 'Eora Move · Move with intention.' }],
    type: 'website',
  },
  twitter: {
    ...
    title: 'Eora Move · Move with intention.',
    description: 'Reformer Pilates, Barre und Mobility für Kraft, Leichtigkeit und echte Verbindung.',
    images: ['https://eora-move.khairab.chatgpt.site/og.png'],
  },
};

export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="de"><body className={`${display.variable} ${body.variable}`}><IntroAnimation />{children}</body></html>;
}
