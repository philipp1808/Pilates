...
export const plans = [
  { value: 'new', kicker: 'Dein Start', name: 'New here', description: 'Zum Kennenlernen – gültig für Reformer, Barre und Mobility.', offers: [
    ...
    { title: 'Welcome Week', sessions: 'Unbegrenzte Trainings', validity: '7 Tage', price: '79 €' },
  ] },
  { value: 'more', kicker: 'Deine Routine', name: 'Want more', description: 'Flexibel trainieren und deinen Rhythmus finden.', offers: [
    ...
    { title: 'Move 20', sessions: '20 Trainings', validity: '6 Monate', price: '359 €' },
  ] },
  { value: 'exclusive', kicker: 'Dein Commitment', name: 'Exclusive', description: 'Wähle zwischen Mat Classes und Reformer Classes – jeweils mit drei flexiblen Möglichkeiten.', offers: [] },
];

export const exclusivePackages = [
  { name: 'Mat Packages', kicker: 'Barre & Mobility', offers: [
    { title: 'Single Class', validity: 'Gültig 30 Tage', price: '22 €' },
    { title: '5 Classes', validity: 'Gültig 8 Wochen', price: '99 €' },
    { title: '10 Classes', validity: 'Gültig 12 Wochen', price: '179 €' },
  ] },
  { name: 'Reformer Packages', kicker: 'Reformer Pilates', offers: [
    { title: 'Single Class', validity: 'Gültig 30 Tage', price: '32 €' },
    { title: '5 Classes', validity: 'Gültig 8 Wochen', price: '149 €' },
    { title: '10 Classes', validity: 'Gültig 12 Wochen', price: '279 €' },
  ] },
];
